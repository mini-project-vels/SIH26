...
class RoadSegmentationService(VisualGroundingModelInterface):
    """
    Road Network Segmentation Specialist.
    Available model utilizing pixel-based road range signatures.
    """
